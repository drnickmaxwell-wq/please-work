    ...
    <section className="cpv-card" aria-labelledby="treatments-stories-heading">
      <div className="cpv-card__inner cpv-card__inner--stack">
        <div className="cpv-card__header">
          <p className="cpv-card__eyebrow">Patient stories</p>
          <div className="cpv-card__heading">
            <h2 className="cpv-card__title" id="treatments-stories-heading">
        ...
        <div className="stories-grid">
          {stories.map((story) => (
            <article key={story.title} className="stories-grid__card">
              <p className="stories-grid__tag">{story.tag}</p>
              <h3>{story.title}</h3>
              <p className="stories-grid__blurb">{story.blurb}</p>
            </article>
          ))}
        </div>
        <div className="stories-grid__cta">
          <Link className="cpv-btn cpv-btn-solid" href="/patient-stories">
            View all stories
          </Link>
        </div>
      </div>
