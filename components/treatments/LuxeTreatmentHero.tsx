...
const VARIANT_THEMES: Record<LuxeTreatmentHeroVariant, CSSProperties> = {
  implants: {
    '--lth-stop-magenta': 'color-mix(in srgb, var(--smh-primary-magenta) 88%, transparent)',
    '--lth-stop-blend': 'color-mix(in srgb, var(--smh-primary-magenta) 36%, var(--smh-primary-teal))',
    '--lth-stop-teal': 'color-mix(in srgb, var(--smh-primary-teal) 76%, transparent)',
    '--lth-stop-gold': 'color-mix(in srgb, var(--smh-accent-gold-soft) 38%, transparent)',
    '--lth-ambient-top': 'color-mix(in srgb, var(--smh-primary-magenta) 26%, transparent)',
    '--lth-ambient-bottom': 'color-mix(in srgb, var(--smh-accent-gold-soft) 34%, transparent)',
    '--lth-surface-opacity': '0.28',
    '--lth-glow-strength': '0.54',
    '--lth-speckle-opacity': '0.11',
    '--lth-wave-opacity': '0.48',
  },
  veneers: {
    '--lth-stop-magenta': 'color-mix(in srgb, var(--smh-primary-magenta) 96%, transparent)',
    ...
    '--lth-stop-gold': 'color-mix(in srgb, var(--smh-accent-gold-soft) 44%, transparent)',
    '--lth-ambient-top': 'color-mix(in srgb, var(--smh-primary-magenta) 32%, transparent)',
    '--lth-ambient-bottom': 'color-mix(in srgb, var(--smh-accent-gold-soft) 38%, transparent)',
    '--lth-surface-opacity': '0.26',
    '--lth-glow-strength': '0.6',
    '--lth-speckle-opacity': '0.14',
    '--lth-wave-opacity': '0.52',
  },
  whitening: {
    ...
    '--lth-stop-teal': 'color-mix(in srgb, var(--smh-primary-teal) 72%, transparent)',
    '--lth-stop-gold': 'color-mix(in srgb, var(--smh-accent-gold-soft) 48%, transparent)',
    '--lth-ambient-top': 'color-mix(in srgb, var(--smh-primary-magenta) 26%, transparent)',
    '--lth-ambient-bottom': 'color-mix(in srgb, var(--smh-accent-gold-soft) 38%, transparent)',
    '--lth-surface-opacity': '0.26',
    '--lth-glow-strength': '0.62',
    '--lth-speckle-opacity': '0.12',
    '--lth-wave-opacity': '0.5',
  },
  general: {
    '--lth-stop-magenta': 'color-mix(in srgb, var(--smh-primary-magenta) 94%, transparent)',
    '--lth-stop-blend': 'color-mix(in srgb, var(--smh-primary-magenta) 40%, var(--smh-primary-teal))',
    ...
    '--lth-ambient-bottom': 'color-mix(in srgb, var(--smh-accent-gold-soft) 36%, transparent)',
    '--lth-surface-opacity': '0.24',
  ...
  technology: {
    ...
    '--lth-ambient-bottom': 'color-mix(in srgb, var(--smh-primary-teal) 32%, transparent)',
    '--lth-surface-opacity': '0.26',
    '--lth-glow-strength': '0.52',
    '--lth-speckle-opacity': '0.11',
    '--lth-wave-opacity': '0.46',
  },
};
