# Director Departments Index

Update after every PR; link to preview URLs.

| Department | Conversation title (to create) | Owner AI | Status | Output/PR |
| --- | --- | --- | --- | --- |
| Website Polish | SMH Website — Homepage Polish | Codex | planned | PR: preview(hero) polish only |
| Treatments | SMH Website — Treatments Brightening & Tokenization | Codex (+ Manus assist) | planned | PR: /preview/treatments-light/** |
| Manus Intake | SMH Design Intake — Manus Sections Wiring | Manus → Codex | planned | PR: /preview/imports/* |
