...
export const viewport: Viewport = {
  ...
  userScalable: true,
  themeColor: [
    { media: '(prefers-color-scheme: light)', color: 'var(--brand-magenta)' },
    { media: '(prefers-color-scheme: dark)', color: 'var(--brand-magenta)' },
  ],
  colorScheme: 'light',
  viewportFit: 'cover',
};
  ...
  return (
    <html lang="en-GB" style={rootFontStyle} className="font-sans">
      <head>
        ...
        {/* Microsoft Tiles */}
        <meta name="msapplication-TileColor" content="var(--brand-magenta)" />
